...
<?php apl_open_layer( $layer_name, $apl_unique_id, $css_classes ); ?>
  ...
  <?php foreach( $related_posts as $related ) : ?>
    ...
    if( $related_post ) {
      ...
      $related_post_image = get_the_post_thumbnail( $related_post->ID, 'post_thumbnail', array( 'class' => 'img-responsive center-block' ) );
    ...
    if( $customize ) {
      ...
      $related_post_image = ( $related['image'] ) ? wp_get_attachment_image( $related['image']['ID'], 'post_thumbnail', false, array( 'class' => 'img-responsive center-block' ) ) : $related_post_image;
